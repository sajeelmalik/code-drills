...
function fizzBuzzDataTypeChecker(dataTypeInput){
  ...
  // ---------- Your Code Here ----------
    ...
    if(typeof dataTypeInput === "string"){
...
function dataTypeObj(dataTypeInput){
  ...
  for(var i = 0; i < Object.keys(dataTypeInput).length; i++){
    fizzBuzzDataTypeChecker(dataTypeInput[Object.keys(dataTypeInput)[i]]);
 }
